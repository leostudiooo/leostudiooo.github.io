(() => {
                            ...
                            ! function(e) { e.llTempImage = document.createElement("IMG") }(e), G(e, n, t),
                                function(e, n, t) {
                                    var r = h(e, n.data_bg),
                                        ...
                                        l = a && i ? i : r;
                                    l && (e.style.backgroundImage = 'url("'.concat(l, '")'), k(e).setAttribute("src", l), R(e, n, t))
                                }(e, n, t),
                                function(e, n, t) {
                    ...
                    return ae.prototype = {
                        update: function(e) {
                            var n, i, a = this._settings,
                                l = ie(e, a);
                            A(this, l.length), !t && r ? Q(a) ? function(e, n, t) { e.forEach((function(e) {-1 !== K.indexOf(e.tagName) && (e.setAttribute("loading", "lazy"), function(e, n, t) { G(e, n, t), B(e, n), v(e, g) }(e, n, t)) })), A(t, 0) }(l, a, this) : (i = l, function(e) { e.disconnect() }(n = this._observer), function(e, n) { n.forEach((function(n) { e.observe(n) })) }(n, i)) : this.loadAll(l)
                        },
    ...
    (() => {
        ...
        "mediaSession" in navigator && (navigator.mediaSession.setActionHandler("play", In), navigator.mediaSession.setActionHandler("pause", Dn), navigator.mediaSession.setActionHandler("seekbackward", (() => {
            let e = Un.querySelector(".penguin-player__audio");
            e.currentTime = Math.max(0, e.currentTime - 10)
        })), navigator.mediaSession.setActionHandler("seekforward", (() => {
            let e = Un.querySelector(".penguin-player__audio");
            e.currentTime = Math.min(e.duration, e.currentTime + 10)
        })), navigator.mediaSession.setActionHandler("previoustrack", jn), navigator.mediaSession.setActionHandler("nexttrack", Nn));
        ...
        let x, w, E, S, M = 0,
            k = { main: {}, sub: {} };
        h("setup", (() => {
            x = Un.querySelector(".penguin-player__audio"), [k.main.el, k.sub.el] = [Un.querySelector(".penguin-player__lyric--line[line-name=main]"), Un.querySelector(".penguin-player__lyric--line[line-name=sub]")], x.addEventListener("playing", (() => { z = H = 0, q() })), window.addEventListener("mousedown", (e => {
                Un.querySelector(".penguin-player__lyric-settings").classList.contains("penguin-player__lyric-settings-shown") ? e.target instanceof HTMLElement && null == e.target.closest(".penguin-player__lyric-settings") && P() : e.pageY >= window.innerHeight - 60 && e.pageX >= 76 && Un.querySelector(".penguin-player__player").clientWidth <= 56 && window.innerWidth <= 700 && (! function() {
                    let e = (new Date).getTime() - w;
                    e < 600 && e > 0 && P();
                    w = (new Date).getTime()
                }(), e.preventDefault())
            })), Un.querySelector(".penguin-player__lyric--expand-button").addEventListener("click", (() => P())), Un.querySelector(".penguin-player__lyric-settings--overlay").addEventListener("click", (() => P(!1)));
            let e = Un.querySelector(".penguin-player__lyric-settings--lyric-offset-value");
            Un.querySelector(".penguin-player__lyric-settings--lyric-offset-up").addEventListener("click", (() => { e.stepUp(), m(e, "change") })), Un.querySelector(".penguin-player__lyric-settings--lyric-offset-down").addEventListener("click", (() => { e.stepDown(), m(e, "change") })), e.addEventListener("change", (function() {
        ...
        function P(e) {
            let n = Un.querySelector(".penguin-player__lyric-settings");
        ...
        function D(e) {
            I("error", "歌词加载中"), L = T = null, z = H = 0, clearTimeout(S), E && E.cancel(), E = y(`https://gcm.tenmahw.com/resolve/lyric?id=${e.id}`).send().then((e => {
                ...
                L = null == t ? void 0 : t.lrc, T = null == t ? void 0 : t.tlrc, I.apply(null, L ? ["tick", "歌词已加载"].concat(T ? ["tick", "翻译歌词已加载"] : ["error", "无翻译歌词"]) : ["error", "无歌词"]), Un.querySelector(".penguin-player__lyric--background").style.bottom = L ? "" : "-60px"
        ...
        const V = function(e, n, t) { return e == e && (void 0 !== t && (e = e <= t ? e : t), void 0 !== n && (e = e >= n ? e : n)), e };
        var Y = /\s/;
        const F = function(e) { for (var n = e.length; n-- && Y.test(e.charAt(n));); return n };
        var U = /^\s+/;
        const X = function(e) { return e ? e.slice(0, F(e) + 1).replace(U, "") : e };
        const $ = function(e) { var n = typeof e; return null != e && ("object" == n || "function" == n) };
        ...
        const de = function(e, n, t) { return void 0 === t && (t = n, n = void 0), void 0 !== t && (t = (t = ge(t)) == t ? t : 0), void 0 !== n && (n = (n = ge(n)) == n ? n : 0), V(ge(e), n, t) };
        ...
        const Oe = function(e, n, t) {
            ...
            return n = ge(n) || 0, $(t) && (u = !!t.leading, a = (c = "maxWait" in t) ? ze(ge(t.maxWait) || 0, n) : a, y = "trailing" in t ? !!t.trailing : y), v.cancel = function() { void 0 !== o && clearTimeout(o), s = 0, r = p = i = o = void 0 }, v.flush = function() { return void 0 === o ? l : f(Ae()) }, v
        };

        function Ce() { for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n]; return function(n, t, r) { var i = r.value; return { get: function() { return this.hasOwnProperty(t) || Object.defineProperty(this, t, { value: Oe.apply(void 0, R([i], e)) }), this[t] } } } }
        var qe;
        ...
        var Pe = function() {
            ...
            De = function() {
                ...
                }, e.prototype.autoHideOnIdle = function() { this._scrollbar.options.alwaysShowTracks || (this.xAxis.hide(), this.yAxis.hide()) }, B([Ce(300)], e.prototype, "autoHideOnIdle", null), e
            }();
        var Ne = new WeakMap;

        function je(e) { return Math.pow(e - 1, 3) + 1 }
        var Be, Re, Ve, Ye = function() {
                function e(e, n) {
                    var t = this.constructor;
                    this.scrollbar = e, this.name = t.pluginName, this.options = j(j({}, t.defaultOptions), n)
                }
                return e.prototype.onInit = function() {}, e.prototype.onDestroy = function() {}, e.prototype.onUpdate = function() {}, e.prototype.onRender = function(e) {}, e.prototype.transformDelta = function(e, n) { return j({}, e) }, e.pluginName = "", e.defaultOptions = {}, e
            }(),
            ...
            a(r, "touchstart", (function(t) { i.track(t), e.setMomentum(0, 0), 0 === l && (n = e.options.damping, e.options.damping = Math.max(n, .5)), l++ })), a(r, "touchmove", (function(n) {
                if (!Ve || Ve === e) {
                    ...
                    var t = i.getDelta(),
                        r = t.x,
                        a = t.y;
                    e.addTransformableMomentum(r, a, n, (function(t) { t && n.cancelable && (n.preventDefault(), Ve = e) }))
                }
                ...
                })), e.addTransformableMomentum(o.x, o.y, r), 0 === --l && (e.options.damping = n), i.release(r), Ve = null
            }))
        }
        ...
        }! function(e) { e[e.TAB = 9] = "TAB", e[e.SPACE = 32] = "SPACE", e[e.PAGE_UP = 33] = "PAGE_UP", e[e.PAGE_DOWN = 34] = "PAGE_DOWN", e[e.END = 35] = "END", e[e.HOME = 36] = "HOME", e[e.LEFT = 37] = "LEFT", e[e.UP = 38] = "UP", e[e.RIGHT = 39] = "RIGHT", e[e.DOWN = 40] = "DOWN" }(Be || (Be = {})),
        function(e) { e[e.X = 0] = "X", e[e.Y = 1] = "Y" }(Re || (Re = {}));
        var Ke = 1,
            Qe = -3,
            en = [1, 28, 500];
        var nn = new Map,
            tn = function() {
                ...
                return Object.defineProperty(n.prototype, "parent", {
                    ...
                    var i = function(e, n, t) {
                        var r = e.options,
                            ...
                            l = e.track,
                            o = e.contentEl;
                        return r.renderByPixels && (n = Math.round(n), t = Math.round(t)), n = de(n, 0, a.x), t = de(t, 0, a.y), n !== i.x && l.xAxis.show(), t !== i.y && l.yAxis.show(), r.alwaysShowTracks || l.autoHideOnIdle(), n === i.x && t === i.y ? null : (i.x = n, i.y = t, ke(o, { "-transform": "translate3d(" + -n + "px, " + -t + "px, 0)" }), l.update(), { offset: j({}, i), limit: j({}, a) })
                    }(this, e, n);
                ...
                }, B([Ce(100, { leading: !0 })], n.prototype, "_updateDebounced", null), n
            }(),
        ...
        const on = function(e) {
            ...
            return function(e, n) {
                ...
                N(e, n), e.prototype = null === n ? Object.create(n) : (t.prototype = n.prototype, new t)
                ...
                var n = nn.get(e);
                n && n.destroy()
            }, n.destroyAll = function() { nn.forEach((function(e) { e.destroy() })) }, n.use = function() { for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n]; return Ue.apply(void 0, e) }, n.attachStyle = function() { return ln() }, n.detachStyle = function() {
                return function() {
                    if (an && "undefined" != typeof window) {
            ...
            }, n.version = "8.6.1", n.ScrollbarPlugin = Ye, n
        }(tn);
        var pn = t(18),
            sn = t.n(pn);
        ...
        function vn(e, n) {
            ...
            i.style.backgroundColor = t, i.style.color = i.style.fill = r, Un.querySelector(".penguin-player__player--thumbnail-progress-left").style.borderColor = Un.querySelector(".penguin-player__player--thumbnail-progress-right").style.borderColor = r;
            let a = Un.querySelector(".penguin-player__player--full-content"),
        ...
        function bn(e) {
            ! function(e) {
                let n = Un.querySelector(".penguin-player__player--thumbnail-img");
                e ? n.classList.add("rotate") : n.classList.remove("rotate")
            }(e), Un.querySelector(".penguin-player__lyric").style.opacity = e ? "1" : "0"
        }
        h("setup", (() => {
            let e, n = Un.querySelector(".penguin-player__audio");
            n.addEventListener("playing", (() => bn(!0))), n.addEventListener("pause", (() => bn(!1))), n.addEventListener("progress", (function() { this.buffered.length <= 0 || (Un.querySelector(".penguin-player__player--progress-buffered").style.width = (this.buffered.end(this.buffered.length - 1) + ((null == zn ? void 0 : zn.start) || 0)) / En[wn].duration * 100 + "%") })), n.addEventListener("timeupdate", (function() {
                ! function(e) {
                    let n = Un.querySelector(".penguin-player__player--thumbnail-progress"),
                ...
                }(Pn() / En[wn].duration * 100), Un.querySelector(".penguin-player__player--progress-current").textContent = s(Pn()), Un.querySelector(".penguin-player__player--progress-inner").style.width = Pn() / En[wn].duration * 100 + "%"
            })), Un.querySelector(".penguin-player__player--controls-previous").addEventListener("click", jn), Un.querySelector(".penguin-player__player--controls-next").addEventListener("click", Nn), Un.querySelector(".penguin-player__player--full-toggle").addEventListener("click", (function() {
                let e = Un.querySelector(".penguin-player__player");
            ...
            })), Un.querySelector(".penguin-player__player--controls-playlist").addEventListener("click", (() => {
                let e = Un.querySelector(".penguin-player__player");
            ...
            })), Un.querySelector(".penguin-player__player--thumbnail-img").addEventListener("load", (function() { vn(Xn.getColor(this), Xn.getPalette(this)) })), Un.querySelector(".penguin-player__player--thumbnail-play-pause").addEventListener("click", (() => {
                if (56 == Un.querySelector(".penguin-player__player").clientWidth) return;
                let e = Un.querySelector(".penguin-player__audio");
        ...
        let Mn, kn = xn.ListLoop,
            Ln = 0;
        const Tn = () => { Ln++, u(`Cannot play song ${En[wn].name}`), Ln >= 5 ? u(`Failed ${Ln} times, stop trying`) : Nn() };
        let An, zn;
        ...
        function On() {
            let e = Un.querySelector(".penguin-player__player--controls-playmode");
            switch (kn) {
                case xn.List:
        ...
        function Cn() {
            vn([255, 255, 255], [
                ...
                function() {
                    let e = Un.querySelector(".penguin-player__player--thumbnail-img");
            ...
            if ("number" == typeof e) {
                ...
                Cn(),
                    function(e) { Un.querySelector(".penguin-player__player--thumbnail-img").src = e.thumbnail + "?param=48y48", Un.querySelector(".penguin-player__player--name").textContent = e.name, Un.querySelector(".penguin-player__player--artists").textContent = e.artists, "mediaSession" in navigator && (navigator.mediaSession.metadata = new MediaMetadata({ title: e.name, artist: e.artists, album: e.album, artwork: [{ src: e.thumbnail + "?param=96y96", sizes: "96x96" }, { src: e.thumbnail + "?param=128y128", sizes: "128x128" }, { src: e.thumbnail + "?param=192y192", sizes: "192x192" }, { src: e.thumbnail + "?param=256y256", sizes: "256x256" }, { src: e.thumbnail + "?param=384y384", sizes: "384x384" }, { src: e.thumbnail + "?param=512y512", sizes: "512x512" }] })) }(t), Un.querySelector(".penguin-player__player--progress-duration").textContent = s(t.duration), null === (n = Mn) || void 0 === n || n.cancel(), Mn = y(`https://gcm.tenmahw.com/song/url?id=${t.id}`).send().then((e => {
                        if (200 == e.data.code) {
                            let n = e.data.data[0];
                            n.url ? function(e) { hn.maxValue = hn.minValue = null, zn = e.freeTrialInfo, An.src = e.url.replace("http:", "https:"), In(), f("playtrack", e) }(n) : (u(`${t.name} is unavailable`), Nn())
                        } else Tn()
        ...
        let $n; {
            ...
            e.addEventListener("playing", Jn), e.addEventListener("pause", Jn), e.addEventListener("error", (() => { u("Cannot play " + En[wn].name), Nn() })), h("initialized", (() => {
                if (qn(1), "number" == typeof $n.overrideVolume) qn($n.overrideVolume);
        ...
        function Gn(e) {
            if (u("Initializing..."), null == document.querySelector(".penguin-player")) {
                ...
                u("Playlist processed"),
                    function(e) {
                        let n = Un.querySelector(".penguin-player__player--playlist");
