...
> 注：所以我在上课时联想到了 Transformer。全局的注意力机制应当能够很好地捕捉到这种长程依赖关系。后来我去阅读了 AlphaFold 的论文，他们的 Evoformer 就是一种专门设计来处理多序列比对（MSA）信息的 Transformer 模块，能够在序列和结构之间进行交互式的信息传递。这个设计显然是为了更好地捕捉那些长程依赖关系，尤其是在 β 折叠中至关重要的残基配对关系。
